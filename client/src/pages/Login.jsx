    ...
    <div className="min-h-screen w-full bg-[#0a0a0a] flex items-center justify-center p-6 font-['DM_Sans'] text-[#f0ece4] relative">
      ...
      <div className="w-full max-w-md flex flex-col gap-8">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-[#666]">Welcome back. Try not to start a war immediately.</p>
        </div>
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center gap-3 text-[#444] text-xs">
            <div className="flex-1 h-[1px] bg-[#2a2a2a]" />OR
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 px-6 py-3 bg-[#f0ece4] text-[#0a0a0a] rounded-xl text-sm font-medium transition-all hover:bg-white hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="text-center text-sm text-[#555]">
          ...
          <Link to="/register" className="text-[#bbb] hover:text-white transition">
            Create one
          </Link>
        </div>
      </div>
